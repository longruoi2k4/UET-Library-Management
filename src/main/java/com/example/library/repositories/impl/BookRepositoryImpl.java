...
/**
 * Implementation of the IBookRepository interface, providing methods to interact with the database
 * for managing books and related entities.
 */
public class BookRepositoryImpl implements IBookRepository {
  ...
  public void save(Book book) {
    String sql =
        String.format(
            """
                        insert into books(bookId, authorId, categoryId, bookName, quantity, publishDate, isbn)
    ...
    String sqlUpdate =
        String.format(
            """
                        update books set authorId = '%s', categoryId = %d, bookName = '%s', quantity = %d, publishDate = '%s', isbn = '%s'
                        where bookId = '%s';
                        """,
            book.getAuthor(),
            Integer.parseInt(book.getCategory().trim()),
  ...
  public ObservableList<Book> getAllBook() {
    ...
    String sql =
        """
                select b.bookId, a.authorName, c.categoryName, b.bookName, b.quantity, b.publishDate, b.isbn  from books b

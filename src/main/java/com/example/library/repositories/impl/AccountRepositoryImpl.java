...
/**
 * AccountRepositoryImpl is an implementation of the IAccountRepository interface.
 * This class provides methods for interacting with the account data in the database.
 */
public class AccountRepositoryImpl implements IAccountRepository {
  ...
  public void save(Account account) {
    ...
    ResultSet rs =
        dbConnect.executeQuery(
            String.format("SELECT * FROM users WHERE username = '%s'", account.getUsername()));
  ...
  /**
   * Retrieves information about a library reader based on the provided username.
   *
   * @param username The username of the user whose reader information is to be fetched.
   * @return A Reader object containing the reader's details, or null if no reader could be found.
   * @throws RuntimeException if an SQL exception occurs while processing the query.
   */

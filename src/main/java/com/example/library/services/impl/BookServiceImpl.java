...
/**
 * Implementation of the IBookService interface for managing book-related operations.
 * Provides methods for saving, deleting, updating, and retrieving book information
 * from repositories.
 */
public class BookServiceImpl implements IBookService {
  ...
  /**
   * Default constructor for BookServiceImpl.
   * Initializes the book and author repositories with their respective implementations.
   */
  ...
  public void saveBook(Book book) throws Exception {
    boolean isExist = bookRepository.isExistBook(book.getIsbn());
